 ...
 * of a cone with the radius and height being inputs from the user
 * 
	...
	private class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getSource() == calculate) {
				...
				double coneRadius = Double.parseDouble(r);
				double coneHeight = Double.parseDouble(h);
				Cone cone = new Cone(coneRadius,coneHeight);

				volumeResult.setText(Double.toString(cone.getVolume()));
				surfaceResult.setText(Double.toString(cone.getSurfaceArea()));
			}else {
				radius.setText("");
				height.setText("");
